...
export const eventTypes = [
  ...
  "Fashion Show",
  "Photography Walk",
  "Food Tasting/Culinary Experience",
  "DIY/Craft Workshop",
  "Design Meetup",
  "Yoga/Meditation Session",
  "Fitness Bootcamp",
  "Healing Circle/Safe Space",
  "Wellness Retreat",
  "Mental Health Meetup",
  "Vision Board/Goal-Setting Event",
  "Games Night",
  "Speed Dating/Dating",
  "Community Hangout",
  "City Tour/Local Exploration",
  "Volunteer Event",
  "Religious or Faith-Based Gathering",
  "Singles-Only Events",
  "Creator Meetup",
  "Watch Party",
  "Online Class",
  "Instagram/TikTok Live Performance",
