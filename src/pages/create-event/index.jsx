...
// these schemas can be seperated for each formStep, hence each formStep component will have a Formik component
...
const VendorPage = () => {
  ...
  return (
    <Formik
      ...
      onSubmit={() => {}}
    >
      {/* another major issue, alot is passed to formik */}
      {/* we can let each form component say formStep1, 2 and 3 have their individual formik (and validation) which will only wrap the form */}
      {(formProps) => (
        <Layout
