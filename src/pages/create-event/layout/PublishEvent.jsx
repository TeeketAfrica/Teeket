                            ...
                            <Stack direction="column" spacing={2}>
                                ...
                                {eventHosting === "physical" ? (
                                    <Text
                                        ...
                                        fontSize="sm"
                                    >
                                        <Map /> {eventFullAddress.AddressName || eventLocation}
                                    </Text>
                                ) : (
                                    <Text
                                        display="flex"
                ...
                <Box>
                    <Stack direction="column" spacing={6}>
                        ...
                        <Box maxW="600px" w="100%">
                            <FormControl
                                isInvalid={
                                    formik.touched.publishLive &&
                                    formik.errors.publishLive
                                }
                            >
                                <RadioGroup
                                    name="publishLive"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Text
                                                ...
                                                fontSize="sm"
                                            >
                                                This will place your event
                                                publicly for all to see and
                                        ...
                                        >
                                            ...
                                            <Text
                                                ...
                                                fontSize="sm"
                                            >
                                                This will not be public and you
                                                will be able to review the event
                                                from your dashboard to make any
